...
#define _FP_CHECK_SIGNAN_SEMIRAW(fs, wc, X)                                                       \
    do                                                                                            \
    {                                                                                             \
        if (X##_e == _FP_EXPMAX_##fs && !_FP_FRAC_ZEROP_##wc(X) && _FP_FRAC_SNANP_SEMIRAW(fs, X)) \
            FP_SET_EXCEPTION(FP_EX_INVALID | FP_EX_INVALID_SNAN);                                 \
    } while (0)
...
#define _FP_PACK_SEMIRAW(fs, wc, X)                                                                \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            if ((FP_CUR_EXCEPTIONS & FP_EX_INEXACT) || (FP_TRAPPING_EXCEPTIONS & FP_EX_UNDERFLOW)) \
...
#define _FP_DIV(fs, wc, R, X, Y)                                         \
    ...
    {                                                                    \
        ...
        case _FP_CLS_COMBINE(FP_CLS_ZERO, FP_CLS_ZERO):                  \
            ...
            R##_c = FP_CLS_NAN;                                          \
            _FP_FRAC_SET_##wc(R, _FP_NANFRAC_##fs);                      \
            FP_SET_EXCEPTION(FP_EX_INVALID | (X##_c == FP_CLS_INF        \
                                                  ? FP_EX_INVALID_IDI    \
                                                  : FP_EX_INVALID_ZDZ)); \
            break;                                                       \
                                                                         \
    ...
    {                                                                                 \
       ...
       an exception.  */                                                              \
        ...
        {                                                                             \
            ...
            else if ((ex) == 2 || _FP_ISSIGNAN(fs, wc, X) || _FP_ISSIGNAN(fs, wc, Y)) \
...
#define _FP_CMP_CHECK_DENORM(fs, wc, X, Y)                                                              \
    ...
    {                                                                                                   \
        ...
        {                                                                                               \
            ...
            {                                                                                           \
                if ((X##_e == 0 && !_FP_FRAC_ZEROP_##wc(X)) || (Y##_e == 0 && !_FP_FRAC_ZEROP_##wc(Y))) \
                    FP_SET_EXCEPTION(FP_EX_DENORM);                                                     \
            }                                                                                           \
        }                                                                                               \
    } while (0)
...
#define _FP_TO_INT(fs, wc, r, X, rsize, rsigned)                                                                                                  \
    ...
    {                                                                                                                                             \
        ...
        else if ((rsigned) == 2 && (X##_e >= ((_FP_EXPMAX_##fs < _FP_EXPBIAS_##fs + _FP_FRACBITS_##fs + (rsize)-1)                                \
                                                  ? _FP_EXPMAX_##fs                                                                               \
                                                  : _FP_EXPBIAS_##fs + _FP_FRACBITS_##fs + (rsize)-1)))                                           \
        {                                                                                                                                         \
            /* Overflow resulting in 0.  */                                                                                                       \
            (r) = 0;                                                                                                                              \
            FP_SET_EXCEPTION(FP_EX_INVALID | FP_EX_INVALID_CVI | ((FP_EX_INVALID_SNAN && _FP_ISSIGNAN(fs, wc, X)) ? FP_EX_INVALID_SNAN : 0));     \
        }                                                                                                                                         \
        else if ((rsigned) != 2 && (X##_e >= (_FP_EXPMAX_##fs < _FP_EXPBIAS_##fs + (rsize)                                                        \
                                                  ? _FP_EXPMAX_##fs                                                                               \
            ...
            {                                                                                                                                     \
                ...
                if (!X##_s)                                                                                                                       \
                    (r) = ~(r);                                                                                                                   \
                                                                                                                                                  ...
                                                                                                                                                  \
            if (_FP_EXPBIAS_##fs + (rsize)-1 < _FP_EXPMAX_##fs && (rsigned) && X##_s && X##_e == _FP_EXPBIAS_##fs + (rsize)-1)                    \
            {                                                                                                                                     \
        ...
        {                                                                                                                                         \
            ...
            {                                                                                                                                     \
                /* Overflow or converting to the most negative integer.  */                                                                       \
                if (X##_e > _FP_EXPBIAS_##fs + (rsize)-1 || !X##_s || (r) != (((typeof(r))1) << ((rsize)-1)))                                     \
                {                                                                                                                                 \
...
#define _FP_TO_INT_ROUND(fs, wc, r, X, rsize, rsigned)                                                                                                                                                                                                                                                 \
    ...
    {                                                                                                                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                                                                                                                              \
            ...
            {                                                                                                                                                                                                                                                                                          \
            case FP_RND_NEAREST:                                                                                                                                                                                                                                                                       \
                _FP_TO_INT_ROUND_rounds_away = (X##_e == _FP_EXPBIAS_##fs - 1 && !_FP_FRAC_ZEROP_##wc(X));                                                                                                                                                                                             \
                break;                                                                                                                                                                                                                                                                                 \
            case FP_RND_ZERO:                                                                                                                                                                                                                                                                          \
            ...
            else if ((rsize) == 1 && (rsigned) > 0 && _FP_TO_INT_ROUND_rounds_away && !X##_s)                                                                                                                                                                                                          \
            {                                                                                                                                                                                                                                                                                          \
        ...
        {                                                                                                                                                                                                                                                                                              \
            ...
            {                                                                                                                                                                                                                                                                                          \
               ...
               are exactly _FP_WORKBITS fractional bits already).  */                                                                                                                                                                                                                                  \
                int _FP_TO_INT_ROUND_rshift = (_FP_FRACBITS_##fs + _FP_EXPBIAS_##fs - 1 - _FP_WORKBITS - X##_e);                                                                                                                                                                                       \
            ...
            if (X##_e >= (_FP_EXPBIAS_##fs + (rsize)-1 - ((rsigned) > 0 && !X##_s)))                                                                                                                                                                                                                   \
            {                                                                                                                                                                                                                                                                                          \
                if (X##_e > _FP_EXPBIAS_##fs + (rsize)-1 || (X##_e == _FP_EXPBIAS_##fs + (rsize)-1 && (X##_s ? (r) != (((typeof(r))1) << ((rsize)-1)) : ((rsigned) > 0 || (r) == 0))) || ((rsigned) > 0 && !X##_s && X##_e == _FP_EXPBIAS_##fs + (rsize)-2 && (r) == (((typeof(r))1) << ((rsize)-1)))) \
                {                                                                                                                                                                                                                                                                                      \
                    if ((rsigned) != 2)                                                                                                                                                                                                                                                                \
                    {                                                                                                                                                                                                                                                                                  \
                        if ((rsigned) != 0)                                                                                                                                                                                                                                                            \
            ...
            (void)(((rsize) <= _FP_W_TYPE_SIZE)                                                                                                                                                 \
                       ? (                                                                                                                                                                      \
                             {                                                                                                                                                                  \
                                 ...
                                 X##_e = (_FP_EXPBIAS_##fs + _FP_W_TYPE_SIZE - 1 - _FP_FROM_INT_lz);                                                                                            \
                             })                                                                                                                                                                 \
                       : (                                                                                                                                                                      \
                             {                                                                                                                                                                  \
                                 int _FP_FROM_INT_lz;                                                                                                                                           \
            ...
            {                                                                                                                                                                                   \
               ...
               round.  */                                                                                                                                                                       \
                if (_FP_EXPBIAS_##fs + _FP_WFRACBITS_##fs - 1 < X##_e)                                                                                                                          \
                    _FP_FROM_INT_ur = ((_FP_FROM_INT_ur >> (X##_e - _FP_EXPBIAS_##fs - _FP_WFRACBITS_##fs + 1)) | ((_FP_FROM_INT_ur                                                             \
                                                                                                                    << ((rsize) - (X##_e - _FP_EXPBIAS_##fs - _FP_WFRACBITS_##fs + 1))) != 0)); \
                _FP_FRAC_DISASSEMBLE_##wc(X, _FP_FROM_INT_ur, (rsize));                                                                                                                         \
...
#define _FP_EXTEND_CNAN(dfs, sfs, dwc, swc, D, S, check_nan)                                                                                 \
    ...
    {                                                                                                                                        \
        ...
        _FP_STATIC_ASSERT((_FP_EXPMAX_##dfs - _FP_EXPBIAS_##dfs >= _FP_EXPMAX_##sfs - _FP_EXPBIAS_##sfs),                                    \
                          "destination max exponent smaller"                                                                                 \
                          " than source");                                                                                                   \
        _FP_STATIC_ASSERT(((_FP_EXPBIAS_##dfs >= (_FP_EXPBIAS_##sfs + _FP_FRACBITS_##sfs - 1)) || (_FP_EXPBIAS_##dfs == _FP_EXPBIAS_##sfs)), \
        ...
        {                                                                                                                                    \
            ...
            {                                                                                                                                \
                ...
                {                                                                                                                            \
                    ...
                    _FP_FRAC_SLL_##dwc(D,                                                                                                    \
                                       FP_EXTEND_lz + _FP_FRACBITS_##dfs - _FP_FRACTBITS_##sfs);                                             \
                    D##_e = (_FP_EXPBIAS_##dfs - _FP_EXPBIAS_##sfs + 1 + _FP_FRACXBITS_##sfs - FP_EXTEND_lz);                                \
                }                                                                                                                            \
            }                                                                                                                                \
            else                                                                                                                             \
            {                                                                                                                                \
...
#define FP_TRUNC(dfs, sfs, dwc, swc, D, S)                                                                                                 \
    ...
    {                                                                                                                                      \
        ...
        _FP_STATIC_ASSERT(((_FP_EXPBIAS_##sfs >= (_FP_EXPBIAS_##dfs + _FP_FRACBITS_##dfs - 1)) || _FP_EXPBIAS_##sfs == _FP_EXPBIAS_##dfs), \
            ...
            {                                                                                                                              \
                ...
                {                                                                                                                          \
                    ...
                    {                                                                                                                      \
                        ...
                        _FP_FRAC_SRS_##swc(S, (_FP_WFRACBITS_##sfs - _FP_WFRACBITS_##dfs + 1 - D##_e),                                     \
                                           _FP_WFRACBITS_##sfs);                                                                           \
                    }                                                                                                                      \
                    D##_e = 0;                                                                                                             \
                }                                                                                                                          \
...
#define __FP_CLZ(r, x)                                                                                                                                                         \
    do                                                                                                                                                                         \
    {                                                                                                                                                                          \
        _FP_STATIC_ASSERT((sizeof(_FP_W_TYPE) == sizeof(unsigned int) || (sizeof(_FP_W_TYPE) == sizeof(unsigned long)) || (sizeof(_FP_W_TYPE) == sizeof(unsigned long long))), \
...
#define _FP_DIV_MEAT_N_loop(fs, wc, R, X, Y)                                                          \
    ...
    {                                                                                                 \
       ...
       count and exponent accordingly.  */                                                            \
        ...
        do                                                                                            \
        {                                                                                             \
            int _FP_DIV_MEAT_N_loop_msb = (_FP_WS_TYPE)_FP_FRAC_HIGH_##wc(_FP_DIV_MEAT_N_loop_u) < 0; \
            _FP_FRAC_SLL_##wc(_FP_DIV_MEAT_N_loop_u, 1);                                              \
            _FP_FRAC_SLL_##wc(R, 1);                                                                  \
            if (_FP_DIV_MEAT_N_loop_msb || _FP_FRAC_GE_1(_FP_DIV_MEAT_N_loop_u,                       \
                                                         _FP_DIV_MEAT_N_loop_v))                      \
            {                                                                                         \
                _FP_FRAC_SUB_##wc(_FP_DIV_MEAT_N_loop_u,                                              \
                                  _FP_DIV_MEAT_N_loop_u,                                              \
